...
//Тесты на составление заказа в Chrome
...
public class ScooterOrderTestChrome {
    ...
    public ScooterOrderTestChrome(String name, String surname, String address, String phone, String date, String color, String commentary) {
        this.name = name;
